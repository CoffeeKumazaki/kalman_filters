...
set output 'ukf.gif'
do for [i=1: 1700] {
  cx = getValue(i, 2, "../build/ukf_test.txt")
  cy = getValue(i, 3, "../build/ukf_test.txt")
  plot [cx-5:cx+5][cy-5:cy+5]"../build/ukf_test.txt" every ::::i using 2:3 w lp pt 7 ps 1 ti "True Position", \
